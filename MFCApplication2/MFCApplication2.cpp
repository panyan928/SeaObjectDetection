...
BEGIN_MESSAGE_MAP(CMFCApplication2App, CWinAppEx)
	...
	// 基于文件的标准文档命令
//	ON_COMMAND(ID_FILE_SAVE, &CMFCApplication2App::OnFileSave)
	ON_COMMAND(ID_FILE_NEW, &CWinAppEx::OnFileNew)
	//ON_COMMAND(ID_FILE_OPEN, &CWinAppEx::OnFileOpen)
	// 标准打印设置命令
	ON_COMMAND(ID_FILE_PRINT_SETUP, &CWinAppEx::OnFilePrintSetup)
	ON_COMMAND(ID_FILE_OPEN, &CMFCApplication2App::OnFileOpen)
	ON_COMMAND(ID_VIDEO_OPEN, &CMFCApplication2App::OnVideoOpen)
//	ON_COMMAND(ID_PIC_RESET, &CMFCApplication2App::OnPicReset)
...
void CMFCApplication2App::OnFileOpen()
{
	// TODO:  在此添加命令处理程序代码
	CString strFilter;
...
void CMFCApplication2App::OnVideoOpen()
{
	// TODO:  在此添加命令处理程序代码
	// TODO:  在此添加命令处理程序代码
	CString strFilter;
	strFilter = "*.avi|*.avi|*.rmvb|*.rmvb|*.mp4|*.mp4|*.wmv|*.wmv| All Files (*.*) |*.*||";
	CFileDialog dlg(TRUE, NULL, NULL, OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT, strFilter);
